        ...
        {props => (
          ...
          <View>
            <TextInput
              ...
              placeholder='Review title' placeholderTextColor='green'
           ...
           <Text style={globalStyles.errorText}>{props.touched.title && props.errors.title}</Text>
            ...
            <TextInput
              style={globalStyles.input}
              multiline
              placeholder='Review details' placeholderTextColor='green'
            ...
            <TextInput 
              style={globalStyles.input}
              placeholder='Rating (1 - 5)' placeholderTextColor='#343148FF'
